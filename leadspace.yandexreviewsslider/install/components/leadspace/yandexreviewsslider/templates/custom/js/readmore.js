...
!(function (t) {
    ...
    var s = "readmore",
        r = {
            ...
            collapsedHeight: 200,
            heightMargin: 16,
            moreLink: '<a href="#" class="lsyr-readmore">Показать полностью <i class="fa fa-angle-down" aria-hidden="true"></i></a>',
            lessLink: '<a href="#" class="lsyr-readless">Скрыть <i class="fa fa-angle-up" aria-hidden="true"></i></a>',
            embedCSS: !0,
